...
public class MFConstants {
    ...
    public static final String MFEventChannelGPayName = "onEventChannelGPay";
    ...
    public static class ChannelName {
        ...
        public static final String executePaymentWithGooglePay = "MF.MFSDKHelper.executePaymentWithGooglePay";
        ...
        public static final String updateSession = "MF.MFSDKHelper.updateSession";
        ...
        public static final String googlePayToken = "MF.MFSDKHelper.googlePayToken";
    }

    public static class ChannelGPayName {
        // MFGooglePayLauncher channel names
        public static final String googlePayLauncherAuto = "MF.MFSDKHelper.googlePayLauncherAuto";
        public static final String googlePayLauncherManual = "MF.MFSDKHelper.googlePayLauncherManual";
        public static final String googlePayLauncherTokenOnly = "MF.MFSDKHelper.googlePayLauncherTokenOnly";
        public static final String googlePayAvailable = "MF.MFSDKHelper.googlePayAvailable";
        public static final String googlePayUpdateAmount = "MF.MFSDKHelper.googlePayUpdateAmount";
        public static final String googlePayOpenSheet = "MF.MFSDKHelper.googlePayOpenSheet";
        public static final String googlePayExecutePayment = "MF.MFSDKHelper.googlePayExecutePayment";
    }
    ...
    public static class BufferType {
        ...
        public static final int MFUpdateSessionRequest = 140;
        public static final int MFUpdateSessionResponse = 141;
