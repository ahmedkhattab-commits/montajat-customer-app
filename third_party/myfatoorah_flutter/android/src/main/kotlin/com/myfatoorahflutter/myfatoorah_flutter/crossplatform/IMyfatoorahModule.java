...
public interface IMyfatoorahModule {
    ...
    void ExecutePaymentWithGooglePay(MFExecutePaymentRequest executePaymentRequest, String lang, IMFCallBack promise);
    ...
    void UpdateSession(MFUpdateSessionRequest updateSessionRequest, IMFCallBack promise);
    ...
    void SetupGooglePayTokenHelper(GooglePayRequest googlePayRequest, IMFCallBack promise);
